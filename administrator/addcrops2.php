                      ...
                      <table id="fartilizer_quantity_input" class="table table-bordered">
                        <tbody>
                          ...
                          <?php
                                     ...
                                     $conn = mysqli_connect($dbhost,$dbuser,$dbpassword,$dbname);
                                      ...
                                      if(isset($_POST['save'])){
                                           ...
                                           $f_use_per_bigha = $_POST['f_use_per_bigha'];
                                           $f_use_per_hector = $_POST['f_use_per_hector'];
                                           $f_use_per_shotangsho = $_POST['f_use_per_shotangsho'];

                                           /*

                                           $f_name_json = json_encode($f_name);
                                           $f_use_per_bigha_json = json_encode($f_use_per_bigha);
                                           $f_use_per_hector_json = json_encode($f_use_per_hector);
                                           $f_use_per_shotangsho_json = json_encode($f_use_per_shotangsho);
                                          ...
                                          /*
                                           ...
                                           echo '<pre>'; print_r($f_use_per_bigha_json); echo '</pre>';
                                           echo '<pre>'; print_r($f_use_per_hector_json); echo '</pre>';
                                           echo '<pre>'; print_r($f_use_per_shotangsho_json); echo '</pre>';
                                        ...
                                        //  echo $fertilizer_use;
                                          ...
                                          $save = "INSERT INTO crops(name,description,crop_type,use_fartilizer) VALUES('".$cropName."','".$cropDescription."','".$cropType."','".$fertilizer_use."')";
                          ...
                          <tr class="fr_singe_row">
                            <td><input class="form-control" name="fartilizer_name[]"></input></td>
                            ...
                            <td><button type="button" class="btn btn-warning" id="new_fl_btn">Add More</button></td>
                          </tr>
                        </tbody>
                      </table>
