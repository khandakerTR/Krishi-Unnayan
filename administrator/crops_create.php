...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($name_err) && empty($description_err) && empty($salary_err)){
        ...
        $sql = "INSERT INTO crops_type (name, description, is_visible_home) VALUES (?, ?, ?)";
                ...
                <div class="col-md-12">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" accept-charset="utf-8" method="post">
                        ...
                        <div class="form-group <?php echo (!empty($description_err)) ? 'has-error' : ''; ?>">
                            ...
                            <textarea name="address" class="form-control"><?php echo $description; ?></textarea>
