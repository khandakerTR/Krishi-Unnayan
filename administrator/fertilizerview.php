...
$query = "SELECT * FROM fertilizer ORDER BY fid DESC";
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        <h2 class="pull-left">Fertilizer Details</h2>
                        <a href="create.php" class="btn btn-success pull-right">Add New Fertilizer </a>
                    </div>
                    <?php
                    // Include config file
