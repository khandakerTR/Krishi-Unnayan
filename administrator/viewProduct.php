...
if ($link->query($sqlx) === TRUE) {
	  echo'<script type="text/javascript">
           window.location = "listInformation.php"
      </script>'; 
} else {
             ...
             ?>
              <div class="card-body">
                <div class="form-group">
                    ...
                    <img src="../images/product/<?php echo $result['productimage'];?>" height="200" width="200">
                </div>
...
<button type="button" class="btn btn-info" data-toggle="modal" data-target="#changeimg"></i><i class="fa fa-file-image-o" aria-hidden="true"></i>
</i>Change Image</button>
...
<a href="listInformation.php" class="btn btn-info"></i><i class="fa fa-chevron-left" aria-hidden="true"></i>Go Back</a>
                  </div>
                </div>
              </div>
            </div>
  ...
  <div class="modal-dialog" role="document">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
                    <label class="control-label">Product Image (.jpeg/.jpg.png.gif allowed. Max 5 MB)</label>
      ...
      <div class="modal-footer">
        ...
        <button type="submit" name="imgupdate" class="btn btn-primary">Save changes</button>
      </div>
    </div>
  </form>
  </div>
...
while($result = mysqli_fetch_assoc($resultx)){
            ...
            <div class="form-group">
                    ...
                    <input class="form-control" type="text" value="<?php echo $result['productName'];?>" name="productName">
            </div>
            <div class="form-group">
                    <label class="control-label">Product Information</label>
                    <textarea class="form-control" rows="4" id="summernote" name="productInfo"><?php echo $result['productinfo'];?></textarea>
            </div>
