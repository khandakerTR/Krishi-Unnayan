...
if(!isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] !== true){
    header("location: action_calculate.php");
    exit;
}
      ...
      <div class="slider-item" style="background-image:url(images/bg_2.jpg);">
		...
		<section class="ftco-section ftco-no-pt ftco-no-pb ftco-consult">
			<div class="container">
                ...
                <input type="text"  placeholder="<?php echo $number; if ($select=1)
						echo " বিঘা জমির জন্য " ;
					else if ($select=2)
						echo " শতাংশ জমির জন্য " ;
					else if ($select=3)
						echo " হেক্টর জমির জন্য " ;
					
					?>" name="num" class="form-control" disabled>
            </div>
			<div class="form-group" style="color:black">
						ইউরিয়া =  <b><?php print round($uria, 2);  ?></b> কেজি
				</div>
				<div class="form-group" style="color:black">
						টি এস পি(TSP) বা  ডি এ পি(DAP) <b><?php print round($tsp, 2); ?></b> কেজি
				</div>
				<div class="form-group" style="color:black">
						(MOP) =<b><?php print round($mop, 2); ?> </b> কেজি
				</div>
					<div class="form-group" style="color:black">
						জিপ্সাম বা গন্ধক =	<b><?php print round($zipsam, 2); ?> </b> কেজি
				</div>
				<div class="form-group" style="color:black">
						দস্তা = <b><?php print round($dosta, 2); ?></b> কেজি	
				</div>	
        ...
        cursor: pointer;
					 ...
					 <a href="calculate.php" class="button">Back</a>	
				</div>					
