...
<form action="action_dal.php" method = "POST">
	<label  style="color:black">জাতঃ </label>
			...
			<div class="form-group ">
                <input type="text"  placeholder="জমির পরিমাণ" name="jomi"  required>
            </div>
