	    ...
	    <div class="container d-flex align-items-center">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav mr-auto">
				...
				<li class="nav-item"><a href="contact.php" class="nav-link">যোগাযোগ
			  </a></li>
	        </ul>
	      </div>
	    </div>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread">আমাদের সম্পর্কে</h1>
      ...
      <div class="container-fluid px-md-5">
        <div class="row justify-content-center mb-5">
          <div class="col-md-8 text-center heading-section ftco-animate">
            ...
            <h2 class="mb-4">আমাদের কৃষকদের কথা</h2>
            <p>কৃষকদের  মনের কথাগুলো</p>
          </div>
        </div>
              ...
              <div class="item">
                <div class="testimony-wrap d-flex">
                  ...
                  <div class="text pl-4">
                    ...
                    <p>আমি খুব খুশি এই দরনের অনলাইন সেবা পেয়ে</p>
                    <p class="name">আব্দুল্লাহ</p>
              ...
              <div class="item">
                <div class="testimony-wrap d-flex">
                  ...
                  <div class="text pl-4">
                    ...
                    <p>আমি কৃষি বিশেষজ্ঞ সাথে কথা বলে অনেক উপকার পেয়েছি</p>
                    <p class="name">মাহমুদুল</p>
              ...
              <div class="item">
                <div class="testimony-wrap d-flex">
                  ...
                  <div class="text pl-4">
                    ...
                    <p>আমার কৃষি জমিতে পোকার সমস্যা হইছিল পরে আমি এই ওয়েবসাইট এর সহয়তাই সমস্যা সমাদান করতে পারছি</p>
                    <p class="name">আব্দুল করিম</p>
              ...
              <div class="item">
                <div class="testimony-wrap d-flex">
                  ...
                  <div class="text pl-4">
                    ...
                    <p>কততুকু সার প্রয়গ করব বুঝছিলাম না পরে এই ওয়েবসাইট এর মাদ্দম আমি জমির পরিমান লিখে দেওার পর সব কিছু আমক বলে দিয়েছিল</p>
                    <p class="name">আব্দুল রহিম</p>
