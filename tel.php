...
<form action="action_tel.php" method = "POST">
	<label  style="color:black">জাতঃ </label>

										<select name="jat" id="div" required>
										 <option value="">--নির্বাচন করুন--</option>
										  <option value="1">পাম অয়েল</option>
										  <option value="2">সূর্যমুখী</option>
										  <option value="3">সরিষা</option>
										</select>
										</br>
